...
/**
 * WorldFirst list_statements 响应对象。
 *
 * <p>包含接口调用结果、对账单记录列表及分页游标。
 */
public class ListStatementsResponse {
    ...
    /** 对账单记录列表 */
    private List<StatementRecord> items;
     ...
     */
    public List<StatementRecord> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<StatementRecord> items) {
        this.items = items;
    }
