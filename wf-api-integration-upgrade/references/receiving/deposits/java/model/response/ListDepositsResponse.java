...
/**
 * WorldFirst list_deposits 响应对象。
 *
 * <p>包含接口调用结果、存款记录列表及分页游标。
 */
public class ListDepositsResponse {
    ...
    /** 存款记录列表 */
    private List<DepositRecord> items;
     ...
     */
    public List<DepositRecord> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<DepositRecord> items) {
        this.items = items;
    }
