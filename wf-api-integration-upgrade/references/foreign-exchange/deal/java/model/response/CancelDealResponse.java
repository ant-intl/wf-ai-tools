...
/**
 * WorldFirst cancel_a_deal 响应对象。
 *
 * <p>包含接口调用结果及取消后的交易详情，包括取消时间戳和取消费用。
 */
public class CancelDealResponse {
