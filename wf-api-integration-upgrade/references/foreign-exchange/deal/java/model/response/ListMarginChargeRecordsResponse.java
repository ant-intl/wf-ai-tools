...
import {basePackage}.wf.model.domain.MarginChargeRecord;
...
/**
 * WorldFirst list_margin_charge_records 响应对象。
 *
 * <p>包含接口调用结果、保证金追缴记录列表及分页游标。
 */
public class ListMarginChargeRecordsResponse {

    /** 接口调用结果 */
    private Result result;

    /** 保证金追缴记录列表 */
    private List<MarginChargeRecord> items;
     ...
     */
    public List<MarginChargeRecord> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<MarginChargeRecord> items) {
        this.items = items;
    }
