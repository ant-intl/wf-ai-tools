...
/**
 * WorldFirst list_deals 请求对象。
 *
 * <p>用于分页查询 FX 交易记录列表，支持按卖出币种、买入币种、交易状态和创建时间范围过滤。
 */
public class ListDealsRequest {
    ...
    /**
     * 按卖出币种过滤（ISO 4217 三字母代码），如 USD。
     */
    private String sellCurrency;

    /**
     * 按买入币种过滤（ISO 4217 三字母代码），如 HKD。
     */
    private String buyCurrency;

    /**
     * 按交易状态过滤（DealStatus 枚举）。
     */
    private String status;

    /**
     * 创建时间范围起始（ISO 8601 格式）。
     * <p>与 toCreatedAt 配合使用时，最大查询跨度为 31 天。
     */
