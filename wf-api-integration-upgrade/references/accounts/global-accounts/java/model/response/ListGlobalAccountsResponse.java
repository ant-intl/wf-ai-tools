...
/**
 * WorldFirst list_global_accounts 响应对象。
 *
 * <p>包含接口调用结果、全局账户列表及分页游标。
 */
public class ListGlobalAccountsResponse {

    /** 接口调用结果 */
    private Result result;

    /** 全局账户列表，最多 20 条 */
    private List<GlobalAccount> items;
     ...
     */
    public List<GlobalAccount> getItems() {
        return items;
    }
     ...
     */
    public void setItems(List<GlobalAccount> items) {
        this.items = items;
    }
