 ...
 *
 * <p>本文件为 createPayout 接口追加的错误码片段。
 * 若 WfErrorCode.java 已存在，请将以下枚举值追加到已有文件中，不要重复生成整个文件。</p>
 *
 * @author Qoder
 * @version WfErrorCode.java, v 0.1 2026-03-25
 */
public enum WfErrorCode {

    // ====================== 通用错误码（与 inquiryBalance 共享） ======================
    ...
    /** 合约不存在 */
    CONTRACT_NOT_EXIST("CONTRACT_NOT_EXIST", false),

    /** 报价过期，需重新创建报价 */
    QUOTE_EXPIRED("QUOTE_EXPIRED", false),

    /** 代发额度不足 */
    AVAILABLE_QUOTA_NOT_ENOUGH("AVAILABLE_QUOTA_NOT_ENOUGH", false),
    ...
    /** 费用异常，可重试 */
    FEE_EXCEPTION("FEE_EXCEPTION", true),
