...
class WfConfig:
    ...
    Attributes:
        ...
        base_url: WF API base URL（沙箱/生产）
    ...
    def __init__(
        ...
        client_id: str = None,
        user_id: str = None,
        base_url: str = "https://open-sitprod-sg.alipay.com",
        ...
        self.base_url = base_url or os.getenv("WF_BASE_URL", "https://open-sitprod-sg.alipay.com")
